...
Dans un cadre général, un guide d'onde est un objet qui contraint la propagation d'une onde par ses propriétés physiques. Dans le domaine des ondes électromagnétiques aux fréquences radio, par exemple, un tuyau en métal \cite{miller_low-loss_1953} ou un milieu diélectrique \cite{unger_circular_1957} permet de confiner l'onde et de contraindre une propagation unidimensionnelle sur une longue distance. Packard \emph{et al} ont écrit une revue sur l'histoire de ces découvertes \cite{packard_origin_1984}.
...
b1. Fibre à cristaux photoniques (image extraite de Cregan 1999 \cite{cregan_single-mode_1999}), schéma du réseau tubulaire comme dans Vincetti 2010 \cite{vincetti_waveguiding_2010} en b2.\\
