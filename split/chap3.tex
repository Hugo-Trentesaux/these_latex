...
\begin{figure}
\centering
\includegraphics[width=0.8\textwidth]{./files/fiber_illustration.png}
\caption{[Yu and Knigth] TODO changer illustration, schéma fibre Kagomé / tube lattice / negative curvature ...}
\end{figure}
