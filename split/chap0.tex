...
Elle était déjà utilisée en biologie du développement, mais c'est l'application de techniques optiques d'imagerie fonctionnelle qui a permis son succès dans le domaine des neuronsciences fonctionnelles \cite{ahrens_brain-wide_2012}\cite{panier_fast_2013}\cite{ahrens_whole-brain_2013}. Ces techniques ont permis l'étude de phénomènes concernant un petit nombre de neurones répartis à travers tout le cerveau.
...
~\vspace{-3em}%
\begin{wrapfigure}[9]{r}[1.1\width]{0.11\textwidth}%
  \vspace{-15em}
  \begin{flushright}%
