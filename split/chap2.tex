...
% IGN je discute de ces outils en annexe CMTK/3DSlicer
...
% IGN regarder taille de la ROI moyenne par rapport au volume total (somme du masque)
...
% IGN vérifier nombre de segments
% IGN baseline, df/f, régression...
% Z-score
...
% IGN temps de conversion HCImage dcimg -> tiff
% IGN temps de transfert réseau dcimg / tiff
% IGN temps de copie SSD -> SSD, HDD -> HDD
...
% IGN ressortir les benchmarks ordre dimensions
...
% IGN estimer la taille de la ROI sur plusieurs runs
...
% citer Greaney extraocular 2017 pour expliquer l'activation des muscles oculaires
...
% IGN discuter de ces régions (rien trouvé)
